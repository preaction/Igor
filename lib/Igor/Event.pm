...
The name of the event. This is the string that is given to L<Igor::Emitter/on>.
...
Your L<emitter|Igor::Emitter> should check this attribute before trying to do
...
When using L<the emit method|Igor::Emitter/emit>, this is checked automatically
...
This is the base event class for C<Igor::Emitter> objects.
