...
The name of the event. This is the string that is given to C<Igor::Emitter::on>.
...
Your L<Igor::Emitter|emitter> should check this attribute before trying to do
...
When using L<Igor::Emitter/emit|the emit method>, this is checked automatically
