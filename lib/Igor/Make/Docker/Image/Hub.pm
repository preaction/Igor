...
=head1 SYNOPSIS
    ...
    ### Igorfile
    nordaaker/convos:
        $class: Igor::Make::Docker::Image::Hub
        image: nordaaker/convos

=head1 DESCRIPTION

This L<Igor::Make> recipe class will update a Docker image by checking
Docker Hub for changes.

This class inherits all attributes from L<Igor::Make::Docker::Image>.

=head1 SEE ALSO

L<Igor::Make::Docker::Image>, L<Igor::Make::Docker::Container>, L<Igor::Make>, L<https://docker.com>
...
extends 'Igor::Make::Docker::Image';
