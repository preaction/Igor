...
Igor is a dependency injection (DI) container. A DI (dependency injection)
...
Igor loads a configuration L<file|file> and stores the specified configuration
...
Attach event listeners using L<Igor::Emitter|Igor::Emitter>.
...
Igor objects can hold other Igor objects!
...
container. If even more control is needed, you can make a subclass of Igor.
...
The file attribute contains the file path of the file where Igor container
