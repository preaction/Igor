...
Igor - A Dependency Injection Container
...
Igor is a dependency injection container.
...
Igor can read a YAML file to fill a container with services. The file should be a single hashref.
...
If even more control is needed, you can make a subclass of Igor.
