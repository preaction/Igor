...
END {
    ...
    system 'docker', 'kill', 'igor-make-test-container';
...
subtest 'edit configuration and remake' => sub {
    my $inspect_cmd = 'docker container inspect igor-make-test-container';
    ...
    $make->run( 'igor-make-test-container', "HOME=$home" );
